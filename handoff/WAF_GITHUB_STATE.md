...
There are two abandoned verification branches created during Git data-control experiments (`phase1-complete` and `phase1-complete-verified`). They are not authoritative and should not be used as the source of truth.
